...
if __name__ == "__main__":
    ...
    if True:#args.board:
        ...
        start_state = GameState(4,5)#(args.nrows, args.ncols)
"""
    #play_game(players[0], players[1], start_state)
    #start_state = GameState(list(test_boards.boards['choose_middle']))
    start_state = GameState(4,5)
    play_game(RandomAgent(),MinimaxAgent(), start_state)
